      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '0.95rem', color: '#94a3b8', margin: 0, lineHeight: '1.5' }}>
            University Scholars & Academics Hub Gateway
          </p>
        </div>
          ...
          <>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '10px', fontSize: '0.88rem', color: '#cbd5e1' }}>
                <span>✨</span> <span>Access all university portals instantly from your home screen</span>
              </div>
              <div style={{ display: 'flex', gap: '10px', fontSize: '0.88rem', color: '#cbd5e1' }}>
                <span>⚡</span> <span>Faster loading times & offline support</span>
              </div>
              <div style={{ display: 'flex', gap: '10px', fontSize: '0.88rem', color: '#cbd5e1' }}>
                <span>🔔</span> <span>Stay connected with the latest gateway updates</span>
              </div>
            </div>

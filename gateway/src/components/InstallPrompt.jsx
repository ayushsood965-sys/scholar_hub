...
const InstallPrompt = () => {
  ...
  const appName = "ScholarSync Gateway";
  const appSubtitle = "University Scholars & Academics Hub Gateway";
  const valueProps = [
    "Access all university portals instantly from your home screen",
    "Faster loading times & offline support",
    "Stay connected with the latest gateway updates"
  ];

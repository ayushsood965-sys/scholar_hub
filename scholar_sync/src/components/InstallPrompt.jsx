...
const InstallPrompt = () => {
  ...
  const [srcPortal, setSrcPortal] = useState('SCHOLAR_SYNC');
  ...
  const appName = "ScholarSync";
  const appSubtitle = "Simplify Academic & PhD Thesis Progress Tracking";
  const valueProps = [
    "Access your dashboard instantly from your home screen",
    "Faster loading times & offline support",
    "Get real-time academic review notifications"
  ];

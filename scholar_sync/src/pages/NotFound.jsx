...
const NotFound = () => {
  ...
  const isSync = hostname.includes('sync') || hostname.includes('localhost'); // local development acts as ScholarSync context
    ...
    <div className="nf-container" style={styles.wrapper}>
      ...
      <div style={styles.card}>
        <div style={styles.logoContainer}>
          ...
          <span style={styles.logoText}>ScholarSync</span>
        </div>
...
const styles = {
  ...
  blob1: {
    width: '450px',
    height: '450px',
    backgroundColor: '#34d399', // Emerald/Sync theme
    top: '-10%',
    left: '10%',
  ...
  blob2: {
    width: '500px',
    height: '500px',
    backgroundColor: '#059669', // Emerald/Sync Dark
    bottom: '-15%',
    right: '5%',
  ...
  header404: {
    ...
    margin: '0',
    lineHeight: '1',
    background: 'linear-gradient(135deg, #34d399 0%, #059669 50%, #38bdf8 100%)',
    WebkitBackgroundClip: 'text',
    WebkitTextFillColor: 'transparent',
    letterSpacing: '-0.02em',
    textShadow: '0 10px 40px rgba(52, 211, 153, 0.15)',
  },
  title: {
    fontSize: '1.8rem',
    fontWeight: '600',

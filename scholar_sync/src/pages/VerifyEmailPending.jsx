  ...
  return (
    <div className="subpage-container" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="glass-card" style={{ maxWidth: '500px', width: '90%', padding: '40px', borderRadius: '24px', textAlign: 'center', backdropFilter: 'blur(20px)', backgroundColor: 'rgba(255, 255, 255, 0.45)', boxShadow: '0 20px 40px rgba(0, 0, 0, 0.05)', border: '1px solid rgba(255, 255, 255, 0.4)', zIndex: 10 }}>
        ...
        <div style={{ width: '80px', height: '80px', borderRadius: '50%', background: 'linear-gradient(135deg, #6366F1 0%, #4338CA 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px', boxShadow: '0 8px 24px rgba(99, 102, 241, 0.3)', position: 'relative' }}>
          <div className="ping-ring" style={{ position: 'absolute', width: '100%', height: '100%', borderRadius: '50%', border: '2px solid #6366F1', animation: 'ping 1.5s cubic-bezier(0, 0, 0.2, 1) infinite' }}></div>
        ...
        <div style={{ backgroundColor: 'rgba(99, 102, 241, 0.08)', borderRadius: '12px', padding: '16px', border: '1px solid rgba(99, 102, 241, 0.2)', marginBottom: '28px', textAlign: 'left' }}>
          <p style={{ fontSize: '0.88rem', color: '#4338CA', margin: 0, lineHeight: 1.5, fontWeight: 500 }}>
            📌 <strong>Important:</strong> Until your email address is verified, access to your ScholarSync dashboard and other features will remain completely locked.
          </p>
        </div>
        ...
        <button
          ...
          style={{ 
            ...
            gap: '8px',
            backgroundColor: countdown > 0 ? '#9ca3af' : '#6366F1',
            cursor: countdown > 0 || resending ? 'not-allowed' : 'pointer',
            transition: 'all 0.2s ease',
            border: 'none',
            color: '#ffffff',
            boxShadow: countdown > 0 ? 'none' : '0 4px 12px rgba(99, 102, 241, 0.2)'
          }}
        >
        ...
        <div style={{ marginTop: '24px', fontSize: '0.9rem' }}>
          <Link to="/login" style={{ color: '#6366F1', textDecoration: 'none', fontWeight: 600, transition: 'color 0.2s ease' }} onMouseOver={(e) => e.target.style.color = '#4338CA'} onMouseOut={(e) => e.target.style.color = '#6366F1'}>
            &larr; Back to Login
          </Link>
        </div>

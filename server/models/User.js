...
const userSchema = new mongoose.Schema(
  {
    ...
    profile: {
      ...
      hIndex: { type: mongoose.Schema.Types.Mixed, default: '' },
      i10Index: { type: mongoose.Schema.Types.Mixed, default: '' },
      scopusCitations: { type: mongoose.Schema.Types.Mixed, default: '' },
      googleScholarCitations: { type: mongoose.Schema.Types.Mixed, default: '' },
      ...
      conferenceProceedings: { type: mongoose.Schema.Types.Mixed, default: [] },
      workshops: { type: mongoose.Schema.Types.Mixed, default: [] },
      symposiums: { type: mongoose.Schema.Types.Mixed, default: [] },
      training: { type: mongoose.Schema.Types.Mixed, default: [] },
      ipr: { type: mongoose.Schema.Types.Mixed, default: [] },
      allowProfileEdit: { type: Boolean, default: false },
      privacySettings: {

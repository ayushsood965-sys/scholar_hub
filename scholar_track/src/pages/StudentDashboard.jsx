    ...
    <div className="app-container">
      ...
      <div className="sidebar">
        ...
        <div className="sidebar-nav">
          ...
          >
            <Clock className="nav-icon" /> My Attendance
          </button>
          ...
          >
            <CalendarRange className="nav-icon" /> Leave Management
          </button>
        </div>
      ...
      <div className="main-content">
        ...
        <div style={{ height: '70px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 30px', borderBottom: '1px solid var(--color-border)' }}>
          <div style={{ fontSize: '1.2rem', fontWeight: 700 }}>
            {activeTab === 'overview' ? 'Profile Overview' : 'Attendance Control Center'}
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            <ThemeToggle />
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'var(--color-primary)', color: 'white', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', fontWeight: 'bold' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '30px' }}>
                  ...
                  <div className="glass-panel" style={{ padding: '30px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: '1.1rem', fontWeight: 700, marginTop: '2px' }}>Student / Research Scholar</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="glass-panel" style={{ padding: '30px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                      ...
                      <div>
                        <span style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', fontWeight: 600, textTransform: 'uppercase' }}>Supervisor / Research Guide</span>
                        <div style={{ fontSize: '1.1rem', fontWeight: 700, marginTop: '2px' }}>Dr. Rajesh Kumar</div>
                      </div>
                      <div>
                        <span style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', fontWeight: 600, textTransform: 'uppercase' }}>Tentative Thesis Title</span>
                        <div style={{ fontSize: '1.1rem', fontWeight: 700, marginTop: '4px', lineHeight: '1.4', fontStyle: 'italic' }}>
                          "A Hybrid Decentralized Framework for Smart City IoT Sensor Registries"
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '25px', marginBottom: '30px' }}>
                  <div className="clay-card" style={{ padding: '24px', background: 'var(--color-surface)' }}>
                    <span style={{ fontSize: '0.82rem', color: 'var(--color-text-muted)', fontWeight: 700, textTransform: 'uppercase' }}>My Attendance</span>
                    <div style={{ fontSize: '1.8rem', fontWeight: 800, color: 'var(--color-primary)', marginTop: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <UserCheck size={24} /> Biometric Ratios (75% Threshold)
                    </div>
                  </div>
                  <div className="clay-card" style={{ padding: '24px', background: 'var(--color-surface)' }}>
                    <span style={{ fontSize: '0.82rem', color: 'var(--color-text-muted)', fontWeight: 700, textTransform: 'uppercase' }}>Active Leaves</span>
                    <div style={{ fontSize: '1.8rem', fontWeight: 800, color: '#0284c7', marginTop: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <CalendarRange size={24} /> Medical & Duty Leaves
                    </div>
                  </div>
                  <div className="clay-card" style={{ padding: '24px', background: 'var(--color-surface)' }}>
                    <span style={{ fontSize: '0.82rem', color: 'var(--color-text-muted)', fontWeight: 700, textTransform: 'uppercase' }}>Verification Status</span>
                    <div style={{ fontSize: '1.8rem', fontWeight: 800, color: '#d97706', marginTop: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <Clock size={24} /> Pending Guide Sign-off
                    </div>
                  </div>
                </div>

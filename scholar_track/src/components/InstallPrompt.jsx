      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '0.95rem', color: '#94a3b8', margin: 0, lineHeight: '1.5' }}>
            Enterprise Attendance & Compliance Portal
          </p>
        </div>
          ...
          <>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '10px', fontSize: '0.88rem', color: '#cbd5e1' }}>
                <span>✨</span> <span>Mark attendance instantly from your home screen</span>
              </div>
              <div style={{ display: 'flex', gap: '10px', fontSize: '0.88rem', color: '#cbd5e1' }}>
                <span>📅</span> <span>Request leaves & track compliance on the go</span>
              </div>
              <div style={{ display: 'flex', gap: '10px', fontSize: '0.88rem', color: '#cbd5e1' }}>
                <span>🔔</span> <span>Get real-time attendance and compliance warnings</span>
              </div>
            </div>
